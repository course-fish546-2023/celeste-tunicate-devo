...
```
`
Code that will potentially take the accession numbers of our diff_genes df and get gene ontology terms for them. Although, I am blasting the reference transcriptome to get the gene names...
```{r}
# Get the gene names
