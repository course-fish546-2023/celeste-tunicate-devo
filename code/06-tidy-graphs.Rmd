...
#eliminate duplicate access num
counts_pro_unico <- distinct(counts_pro)

counts_pro_unico[duplicated(counts_pro_unico)]

rownames(counts_pro_unico) <- counts_pro_unico$access_num 
```
...
counts_top <- counts_pro[top_genes, ]
