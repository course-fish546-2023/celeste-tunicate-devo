...
Here we bypassed the prefetch command available in the SRA Toolkit, and used fasterq-dump to download fastq.gz files to our out-directory.
...
## 2. Created index with Kallisto

To make a reference index I used \~99k mRNA "complete records" for my species of interest from NCBI.
